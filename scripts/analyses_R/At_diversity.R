...
df9 <- df8[df8$Duplication != "singeltons" & df8$Duplication != "unclassified",]
...
ggplot(df9[!is.na(df9$gbMgroup),]) + geom_density(aes(x=Ks,color=as.character(gbMgroup)),size=0.5) + 
	...
	theme_bw()+
	scale_x_continuous(expand=c(0.05,0.05), limits = c(0,5)) + scale_y_continuous(expand=c(0,0), limits=c(0,0.7))
...
ggplot(df9[!is.na(df9$gbMgroup),]) + geom_boxplot(aes(y=Ks,x=as.character(gbMgroup)), 
                                                  col = c("#F8766D", "#C49A00","#53B400", "#00B6EB", "#FB61D7"), size=1,notch=TRUE) + 
	theme_bw()+
	theme(axis.text=element_text(size = 16),axis.ticks=element_line(color="black")) +
	theme(axis.title.x = element_text(size =16),axis.title.y = element_text(size = 16)) +
	scale_x_discrete(labels=labels) + scale_y_continuous(expand=c(0,0), limits = c(0,5))

ggplot(df9[!is.na(df9$teMgroup),]) + geom_boxplot(aes(y=Ks,x=as.character(teMgroup)),col = c("#F8766D", "#C49A00","#53B400", "#00B6EB", "#FB61D7"),size=1,notch=TRUE) + 
	theme_bw()+
	theme(axis.text=element_text(size = 16),axis.ticks=element_line(color="black")) +
	theme(axis.title.x = element_text(size =16),axis.title.y = element_text(size = 16)) +
	scale_x_discrete(labels=labels) + scale_y_continuous(expand=c(0,0), limits = c(0,5))

ggplot(df9[!is.na(df9$unMgroup),]) + geom_boxplot(aes(y=Ks,x=as.character(unMgroup)),col = c("#F8766D", "#C49A00","#53B400", "#00B6EB", "#FB61D7"),size=1,notch=TRUE) + 
	theme_bw()+
	theme(axis.text=element_text(size = 16),axis.ticks=element_line(color="black")) +
	theme(axis.title.x = element_text(size =16),axis.title.y = element_text(size = 16)) +
	scale_x_discrete(labels=labels) + scale_y_continuous(expand=c(0,0), limits = c(0,5))

ggplot(df9[!is.na(df9$gbMgroup),]) + geom_boxplot(aes(y=Ka.Ks,x=as.character(gbMgroup)),col = c("#F8766D", "#C49A00","#53B400", "#00B6EB", "#FB61D7"), size=1,notch=TRUE) + 
	theme_bw()+
	theme(axis.text=element_text(size = 16),axis.ticks=element_line(color="black")) +
	theme(axis.title.x = element_text(size =16),axis.title.y = element_text(size = 16)) +
	scale_x_discrete(labels=labels) + scale_y_continuous(expand=c(0,0),limits=c(0,2))

ggplot(df9[!is.na(df9$teMgroup),]) + geom_boxplot(aes(y=Ka.Ks,x=as.character(teMgroup)),col = c("#F8766D", "#C49A00","#53B400", "#00B6EB", "#FB61D7"),size=1,notch=TRUE) + 
	theme_bw()+
	theme(axis.text=element_text(size = 16),axis.ticks=element_line(color="black")) +
	theme(axis.title.x = element_text(size =16),axis.title.y = element_text(size = 16)) +
	scale_x_discrete(labels=labels) + scale_y_continuous(expand=c(0,0),limits=c(0,2))

ggplot(df9[!is.na(df9$unMgroup),]) + geom_boxplot(aes(y=Ka.Ks,x=as.character(unMgroup)),col = c("#F8766D", "#C49A00","#53B400", "#00B6EB", "#FB61D7"),size=1,notch=TRUE) + 
	theme_bw()+
	theme(axis.text=element_text(size = 16),axis.ticks=element_line(color="black")) +
	theme(axis.title.x = element_text(size =16),axis.title.y = element_text(size = 16)) +
	scale_x_discrete(labels=labels) + scale_y_continuous(expand=c(0,0),limits=c(0,2))
...
ggplot(df9) + geom_violin(aes(y=Ks, x=as.character(teMgroup)), size=1) +
