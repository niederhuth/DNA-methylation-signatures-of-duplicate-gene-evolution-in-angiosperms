...
annotations='ref/annotations/'+sys.argv[1]+'_high_GC.gff'
...
first_feature='gene'
second_feature='CDS'
filtered_data_output='high_gc_filtered_allc.tmp'
output='methylpy/results/'+sys.argv[1]+'_high_gc_metaplot.tsv'
